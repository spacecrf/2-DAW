...
function renderComponentes(){
  ...
  COMPONENTES.forEach(comp=>{
    ...
    el.innerHTML = `
      <div class="row">
        <div><div class="categoria">${comp.categoria}</div><div class="nombre">${comp.nombre}</div></div>
...
function init(){
  ...
  renderComponentes();
  const toggle = document.getElementById('toggle-monitor'); toggle.checked = getMonitorToggle();
  toggle.addEventListener('change', ()=>{ setMonitorToggle(toggle.checked); actualizarTotal(); });
  actualizarTotal();
  document.getElementById('btn-copiar').addEventListener('click', copiarListado);
